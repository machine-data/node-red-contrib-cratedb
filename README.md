...
A [Node-RED](http://nodered.org) node to query [CrateDB](https://crate.io/).
...
Run the following command in the root directory of your Node-RED install
 ...
 The node-red CrateDB node uses a template node to set the query and uses msg.queryParameters as params for the query.
 ...
 The msg it then passed to the CrateDB node.
 If you want the output of the query, check the 'Receive output' box in the CrateDB node.
